...
def get_args():
    ...
    arg_parser.add_argument('--classifier_epochs', '-ce', type=int, default=1000, help="Classifier training epochs")
    ...
    arg_parser.add_argument('--alpha', '-a', type=float, default=10.0, help="Weight of the contrastive loss")
