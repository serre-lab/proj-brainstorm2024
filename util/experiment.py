...
def get_args():
    ...
    arg_parser.add_argument('--seeg_file', '-sf', type=str, default='/gpfs/data/tserre/Shared/Brainstorm_2024/data_segmented.npy', help="Path to the sEEG data file")
    arg_parser.add_argument('--video_dir', '-vd', type=str, default='/gpfs/data/tserre/Shared/Brainstorm_2024/raw_movie', help="Path to the video frames directory")
